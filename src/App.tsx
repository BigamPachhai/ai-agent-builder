  ...
  return (
    <div className="app-container">
      <header className="app-header">
        ...
        <p>
          Design your custom AI personality and capability set with
          drag-and-drop ease
        </p>
          ...
          <div className="drop-zone">
            ...
            <div>
              ...
              {selectedSkillsData.length > 0 ? (
                ...
                <p className="text-muted" style={{ margin: 0 }}>
                  No skills added yet. Start building by selecting skills from
                  the left.
                </p>
              )}
            </div>
          ...
          <div className="saved-agents-header">
            ...
            <button
              ...
              onClick={() => {
                if (
                  confirm(
                    "Are you sure you want to delete all saved agents? This cannot be undone.",
                  )
                ) {
                  setSavedAgents([]);
      ...
      {savedAgents.length === 0 && (
        <section
          className="saved-agents-section"
          style={{ textAlign: "center", padding: "3rem" }}
        >
          <p style={{ fontSize: "1.1rem", color: "#999" }}>
            📭 No saved agents yet. Create and save your first agent to get
            started!
          </p>
        </section>
      )}
